...
wget -nH -np -P tmp --recursive --wait 0.2 --random-wait https://docs.aws.amazon.com/cdk/api/latest/typescript/index.html
wget -nH -np -P tmp --recursive --wait 0.2 --random-wait https://docs.aws.amazon.com/cdk/api/latest/typescript/api/toc.html
